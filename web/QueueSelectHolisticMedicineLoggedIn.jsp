       ...
       class getUserDetails{
           ...
           public ResultSet getRecords(){
               ...
               try{
                    ...
                    String  select = "Select top 10 * from QueueServiceProviders.ProviderInfo where Service_Type like 'Holistic Medicine%' ORDER BY NEWID()"; //SQL query string
    ...
    <body>
        ...
        <div id="content">
            ...
            <div id="main">
                ...
                <form name="GetMoreRecords" action="QueueSelectHolisticMedicineLoggedIn.jsp">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
        ...
        <div id="newbusiness">
            ...
            <div id="ExtraproviderIcons" style="padding-top: 10px;">
                ...
                <center><form action="ByAddressAndTypeSearchResultLoggedIn.jsp" method="POST" style="background-color: #6699ff; border: 1px solid buttonshadow; padding: 5px; border-radius: 5px; width: 500px;">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                    <input type="hidden" name="ServiceType" value="Holistic Medicine" />
             ...
             <center><h4 style="margin: 5px; margin-top: 15px;">Explore Service Providers</h4></center>
                ...
                <center><table id="providericons">
                        ...
                        <tr>
                            ...
                            <td style="background-color: pink; width: 33.3%;"><center><a href="QueueSelectHolisticMedicineLoggedIn.jsp?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>"><p style="margin:0;" name="HolMedSelect">Holistic Medicine</p><img src="icons/icons8-pill-filled-70.png" width="70" height="70" alt="icons8-pill-filled-70"/>
                            </a></center></td>
