...
<html>
    ...
    %>
        ...
        ProviderPhotos.ProviderID = 0;
            ...
            */
            ...
            ProviderPhotos.ProviderID = Integer.parseInt(request.getParameter("UserID"));
    ...
    <%
        ...
        try{
            ...
            BlockedYouPst.setInt(2,UserAccount.UserID);
    ...
    %>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <div class="proinfo" style="padding-left: 0;">
                                ...
                                <tr>
                                    <td>
                                       <b><p style="font-size: 20px; text-align: center;"><span><!--img src="icons/icons8-user-15.png" width="15" height="15" alt="icons8-user-15"/-->
                                                   <%=fullName%></span></p></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="margin-left: 0;"><img src="icons/icons8-business-15.png" width="15" height="15" alt="icons8-business-15"/>
        ...
        %>
            ...
            <a href='ViewSelectedProviderReviews.jsp'><p style='clear: both; text-align: center; color: greenyellow; cursor: pointer;'>See More...</p></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 100px; height: 110px; background-image: url('data:image/jpg;base64,<%=sixthPic%>'); background-size: cover; box-shadow: 0 0 0 0; border-radius: 0; border-radius: 5px; padding-top: 0;">
                                                        <div style="background-color: black; opacity: 0.7; width: 96%; height: 96%; cursor: pointer; margin-left: 2px;">
                                                            <a href="ViewProviderPhotos.jsp"><p style="color: white; text-align: center; padding-top: 20px;"><img src="icons/icons8-photo-gallery-20 (1).png" width="20" height="20" alt="icons8-photo-gallery-20 (1)"/>
                                                            </p>
                                     ...
                                     <p style="color: tomato;">Select service(s) to continue<%=For%><%=FormattedAppointmentTime%></p>
                                        ...
                                        <%  
                                            ...
                                            for(int j = 0; j < providersList.get(i).SVCPRC.getNumberOfServices(); j++){
                                                ...
                                                String ServiceAndPrice = providersList.get(i).SVCPRC.getService(j) + " - $" + providersList.get(i).SVCPRC.getPrice(j).substring(0,5);
                                        ...
                                        %>
                                            ...
                                            <input type="hidden" name="<%=PriceOfService%>" value="<%=providersList.get(i).SVCPRC.getPrice(j).substring(0,5)%>" />
                                        ...
                                        <p id="SVCSelectStatus" style="background-color: red; color: white; text-align: center;"></p>
                                            ...
                                            <input type="hidden" name="AppointmentTime" value="<%=AppointmentTime%>" />
                                                   ...
                                                   <p style="text-align: center; color: white; background-color: red;">You're not allowed to schedule with <%=fullName%></p>
                                                   <%}%>
