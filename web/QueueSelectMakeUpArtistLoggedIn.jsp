       ...
       class getUserDetails{
           ...
           public ResultSet getRecords(){
               ...
               try{
                    ...
                    String  select = "Select top 10 * from QueueServiceProviders.ProviderInfo where Service_Type like 'Makeup Artist%' and Provider_ID in "+ IDList + " ORDER BY NEWID()"; //SQL query string
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';">
                                    ...
                                    try{
                                        ...
                                        while(newsRec.next()){
                                            ...
                                            try{    
                                                ...
                                                if(!ServiceType.contains("Makeup Artist")){
                                                    newsItems -= 1;
                                                    continue;
                                                }
                    %>
        ...
        <div id="content">
            ...
            <div id="main">
                ...
                <form name="GetMoreRecords" action="QueueSelectMakeUpArtistLoggedIn.jsp">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                ...
                %>
                    <center><p style="font-size: 16px; background-color: red; color: white; margin-top: 200px; width: fit-content; padding: 5px;">
                        No Makeup Artists found at this time. Use search box above to explore more
                    </p></center>
                <%
                    }
                %>
            ...
            <div id="ExtraproviderIcons" style="">
                ...
                <center><form action="ByAddressAndTypeSearchResultLoggedIn.jsp" method="POST" style="background-color: #6699ff; border: 1px solid buttonshadow; padding: 5px; border-radius: 5px; width: 90%;">
                    ...
                    <p style="color: #000099;"><img src="icons/icons8-marker-filled-30.png" width="15" height="15" alt="icons8-marker-filled-30"/>
                        Find makeup artists at location below</p>
