       ...
       class getUserDetails{
           ...
           public ResultSet getRecords(){
               ...
               try{
                    ...
                    String  select = "Select top 10 * from QueueServiceProviders.ProviderInfo where Service_Type like 'Dentist%' ORDER BY NEWID()"; //SQL query string
             ...
             <center><h4 style="margin: 5px; margin-top: 15px;">Explore Service Providers</h4></center>
                ...
                <center><table id="providericons">
                        ...
                        <tr>
                            ...
                            <td style="background-color: pink;"><center><a href="QueueSelectDentistLoggedIn.jsp?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>"><p style="margin:0;">Dentist</p><img src="icons/icons8-tooth-filled-70.png" width="70" height="70" alt="icons8-tooth-filled-70"/>
                            </a></center></td>
