...
<html>
    ...
    <% 
        ...
        //JOptionPane.showMessageDialog(null, session.getAttribute("UserCity").toString());
        //JOptionPane.showMessageDialog(null, session.getAttribute("UserTown").toString());
        //JOptionPane.showMessageDialog(null, config.getServletContext().getAttribute("UserZipCode").toString());
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';" style="padding-bottom: 0; background-color: #ccccff;">
        ...
        <div id="PermanentDiv" style="">
            ...
            <a onclick="document.getElementById('PageLoader').style.display = 'block';" href="Queue.jsp" id='ExtraDrpDwnBtn' style='margin-top: 2px; margin-left: 2px;float: left; width: 80px; font-weight: bolder; padding: 4px; cursor: pointer; background-color: cadetblue; color: white; border-radius: 4px;'>
            ...
            <div id="ExtraDivSearch" style='background-color: cadetblue; padding: 3px; padding-right: 5px; margin-top: 1.2px; padding-left: 5px; border-radius: 4px; max-width: 590px; float: right; margin-right: 5px;'>
            ...
            <div id="main">
                ...
                %>
                    <center><p style="font-size: 16px; background-color: red; color: white; margin-top: 200px; margin-bottom: 200px; width: fit-content; padding: 5px;">
                        No services found at this time. Use search box above to explore more
                    </p></center>
                <%
                    }
                %>
        ...
        <div id="newbusiness">
            ...
            <div id="ExtraproviderIcons" style="padding-top: 10px;">
                ...
                <div id="SearchDivNB">
                <center><form action="ByAddressSearchResult.jsp" method="POST" style="background-color: #9bb1d0; border: 1px solid buttonshadow; padding: 5px; border-radius: 5px; width: 90%;">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
             ...
             <center><h4 style="margin: 5px; margin-top: 15px;">Explore Service Providers</h4></center>
                ...
                <center><table id="providericons">
                        <tbody>
                        <tr>
                            <td style="width: 33.3%;"><center><a onclick="document.getElementById('PageLoader').style.display = 'block';" href="QueueSelectBusiness.jsp"><p style="margin:0;">All Services</p><img src="icons/icons8-ellipsis-filled-70.png" width="70" height="70" alt="icons8-ellipsis-filled-70"/>
                            </a></center></td>
                        ...
                        <tr>
                            <td><center><a onclick="document.getElementById('PageLoader').style.display = 'block';" href="QueueSelectHolisticMedicine.jsp"><p style="margin:0;" name="HolMedSelect">Holistic Medicine</p><img src="icons/icons8-mortar-and-pestle-100.png" width="70" height="70" alt="icons8-pill-filled-70"/>
                            </a></center></td>
