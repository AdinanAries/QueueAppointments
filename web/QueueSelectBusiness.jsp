        ...
        <div id="newbusiness">
            ...
            <div id="ExtraproviderIcons">
                ...
                <center><form action="ByAddressSearchResult.jsp" method="POST" style="background-color: #9bb1d0; border: 1px solid buttonshadow; padding: 5px; border-radius: 5px; width: 90%;">
                    ...
                    <p><input onclick="document.getElementById('PageLoader').style.display = 'block';" type="submit" style="background-color: darkslateblue; color: white; padding: 7px; border-radius: 4px; width: 95%; margin-top: 15px;" value="Search" /></p>
                    </form></center>
                </div>
