    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';" style="padding-bottom: 0; background-color: #ccccff;">
        ...
        <div id="content" style="min-height: 880px;">
            ...
            <div id="main" style="min-height: 880px;">
                ...
                <h4 style="padding: 10px; color: darkblue; text-align: center; margin-bottom: 10px;"><i style="color: orange;" class="fa fa-exclamation-triangle" aria-hidden="true"></i> <%=Message%></h4>
            ...
            <center><form name="AddBusiness" action="SignupAndSendAppointmentController" method="POST">
                    ...
                    <table border="0">
                        ...
                        <div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <p id="CustUserNameStatus" style="color: black; text-align: center; max-width: 240px; margin: 10px 0;"></p>
                                    </td>
                                </tr>
                            ...
                            <p id="SignUpAndBookStatus" style="color: black; width: 200px; padding: 10px 0;"></p>
