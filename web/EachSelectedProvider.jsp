...
<html>
    ...
    <body>
        ...
        <div id="Extras">
            ...
            <center><p style="color: #254386; font-size: 16px; font-weight: bolder; margin-bottom: 10px;">Updates from <%=CurrentProvsName%></p></center>
        ...
        <div id="newbusiness">
            ...
            <center><form name="AddBusiness" action="SignUpPage.jsp" method="POST"><table border="0">
                        <tbody>
                            ...
                            <tr>
                                <td><input id="signUpTelFld" placeholder="enter your telephone/mobile number here" type="text" name="telNumber" value="" size="40"/></td>
                            </tr>
                            <tr>
