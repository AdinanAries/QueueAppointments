...
function toggleShowBlockFutureSpotsForm(){
	...
	if(BlockFutureSpotsForm.style.display === "none"){
		...
		$("#BlockFutureSpotsForm").slideUp("fast");
}
...
function toggleShowCloseFutureDysForm(){
	...
	if(CloseFutureDaysForm.style.display === "none"){
		...
		$("#CloseFutureDaysForm").slideUp("fast");
}
...
function toggleShowMakeReservationForm(){
	...
	if(MakeReservationForm.style.display === "none"){
		...
		$("#MakeReservationForm").slideUp("fast");
}

function togglehideAddClientForm(number){
	
	var deleteAppointmentHistoryFormName = "deleteAppointmentHistoryForm" + number;
	var deleteAppointmentHistoryForm = document.getElementById(deleteAppointmentHistoryFormName);
...
function activateProvAppointmentsTab(){
	...
	var CurrentProvAppointmentsDiv = document.getElementById("CurrentProvAppointmentsDiv");
	var ProviderAppointmentHistoryDiv = document.getElementById("ProviderAppointmentHistoryDiv");
...
function showPhotoUploadwindow(){
	window.open("./UploadPhotoWindow.jsp","_blank", "resizable=yes, scrollbars=yes, titlebar=yes, width=600, height=500, top=10, left=10");
