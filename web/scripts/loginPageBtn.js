function showLoginPageLoginBtn(){
	...
	if((LoginPageUserNameFld.value !== "" && LoginPagePasswordFld.value !== "")){
		...
		loginPageBtn.style.cssText = '#loginPageBtn:hover{ background-color: red; }';
...
function showLoginPageSignUpBtn(){
	...
	if(signUpFirtNameFld.value !== "" && sigUpLastNameFld.value !== "" &&
	   signUpTelFld.value !== "" && signUpEmailFld.value !== ""){
		
		loginPageSignUpBtn.disabled = false;
		loginPageSignUpBtn.style.backgroundColor = "pink";
		loginPageSignUpBtn.style.cssText = '#loginPageSignUpBtn:hover{ background-color: red; }';
