<%-- 
    Document   : QueueConfirmPage
    Created on : Jul 5, 2020, 6:07:47 PM
    Author     : aries
--%>
        ...
        <div style="min-height: 100vh; display: flex; flex-direction: column; justify-content: center;">
            ...
            <div style="min-height: 100%;">
                ...
                <p style="text-align: center; font-family: roboto;">
                    <i style="color: green; text-align: center; font-size: 30px;" class="fa fa-check" aria-hidden="true"> Congratulations!</i>
                </p>
