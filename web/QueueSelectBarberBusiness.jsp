       ...
       class getUserDetails{
           ...
           public void getIDsFromAddress(String city, String town, String zipCode){
               ...
               try{
                   ...
                   String AddressQuery = "Select top 1000 ProviderID from QueueObjects.ProvidersAddress where City like '"+city+"%' and Town like '"+town+"%' ORDER BY NEWID()";
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';" style="padding-bottom: 0; background-color: #ccccff;">
        ...
        <div id="content">
            ...
            <div id="main">
                    ...
                    %>
                            ...
                            <div id="QueuLineDiv">
                                    ...
                                    <%
                                        ...
                                        //ArrayList objects to store spot times
                                        ...
                                        //Daily start times and closing time of each provider
                                        String DailyStartTime = "";
                                        String DailyClosingTime = "";
                                        String FormattedStartTime = "";
                                        String FormattedClosingTime = "";
                                        
                                        //Put time parts such as hour and minutes in these variables
                                        int startHour = 0;
                                        int startMinute = 0;
                                        int closeHour = 0;
                                        int closeMinute = 0;
                                        
                                        //Tracking how many time spots with these variables
                                    ...
                                    <%
                                        ...
                                        //These variables store Starting time and Closing time for each day of the week
                                        ...
                                        //this try block is for assigning starting times and closing times Daily start time and DailyClosing time
                                        //based on which day of week returned by Current Date object
                                        try{
                                                ...
                                                //now setting start hour to and start minute from DailyStarting time(getting different time parts  
                                                ...
                                                //now getting different time compartments of the DailyClosingTime
                ...
                <form name="GetMoreRecords" action="QueueSelectBarberBusiness.jsp">
