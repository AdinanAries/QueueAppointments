    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';">
                                    ...
                                    try{
                                        ...
                                        while(newsRec.next()){
                                            ...
                                            try{    
                                                ...
                                                if(!ServiceType.contains("Personal Trainer")){
                                                    newsItems -= 1;
                                                    continue;
                                                }
                    %>
        ...
        <div id="content">
            ...
            <div id="main">
                                    ...
                                    <td>
                                        <b>
                                            ...
                                            <div style="display: flex; flex-direction: row;">
                                                <div>
                                                    <img style="float: left; margin-right: 3px;" src="icons/icons8-workout-96.png" width="30" height2="30" alt="icons8-home-50 (1)"/>
                                                </div>
                ...
                <form name="GetMoreRecords" action="QueueSelectPersonalTrainerLoggedIn.jsp">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                ...
                %>
                    <center><p style="font-size: 16px; background-color: red; color: white; margin-top: 200px; width: fit-content; padding: 5px;">
                        No Personal Trainer services found at this time. Use search box above to explore more
                    </p></center>
                <%
                    }
                %>
