            ...
            <div id="ExtraproviderIcons" style="margin-top: -13px;">
             ...
             <center><h4 style="margin: 5px; margin-top: 15px;">Explore Service Providers</h4></center>
                ...
                <center><table id="providericons">
                        <tbody>
                        <tr>
                            <td style="width: 33.3%; background-color: pink;"><center><a onclick="document.getElementById('PageLoader').style.display = 'block';" href="QueueSelectBusinessLoggedIn.jsp?UserIndex=<%=UserIndex%>"><p style="margin:0;">All Services</p><img src="icons/icons8-ellipsis-filled-70.png" width="70" height="70" alt="icons8-ellipsis-filled-70"/>
                            </a></center></td>
