                                ...
                                <form action="FinishAppointmentUnloggedIn.jsp" method="POST">
                                    ...
                                    <center>
                                        ...
                                        <input id="submitAppointment" style="border: none; background-color: darkslateblue; border-radius: 5px; color: white;
                                                   padding: 5px;"
                                                  onclick="document.getElementById('PageLoader').style.display = 'block';"  type="submit" value="Confirm" />
                                    </center>
                                </form>
                                        
                                        <center><div id="CreditDebitCardDetails" style="padding: 10px; background-color: #eeeeee;">
                                            <p style="font-weight: bolder; color: crimson; text-align: center;">Add Your Debit/Credit Card</p>
                                            ...
                                            <%}%>
                                                ...
                                                <p  style="color: darkblue; font-weight: bolder; text-align: center;"><i style="color: red;" class="fa fa-exclamation-triangle"></i> <span id="paymentBtnStatus"></span></p>
