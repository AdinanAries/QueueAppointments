    ...
    <body>
        ...
        <div id="nav">
                    <ul>
                        ...
                        <a href="OurReputation.jsp"><li class="active" style="background-color: #6699ff; border: black solid 1px; color: #000099;">Our Reputation</li></a>
                ...
                <div id ="main">
                    <h2 style="color: red; margin-top: 25px;">OUR REPUTATION</h2>
                </div>
            </div>
            <div id="additional">
