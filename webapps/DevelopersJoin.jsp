    ...
    <body>
        ...
        <div id="nav">
                    <ul>
                        ...
                        <a href="DevelopersJoin.jsp"><li class="active" style="background-color: #6699ff; border: black solid 1px; color: #000099;">Join AriesLab</li></a>
            ...
            <div id ="main">
                    <h2 style="color: red; margin-top: 25px;">Join US</h2>
            </div>
            </div>
            <div id="additional">
