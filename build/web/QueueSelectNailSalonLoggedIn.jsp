       ...
       class getUserDetails{
           ...
           public ResultSet getRecords(){
               ...
               try{
                    ...
                    String  select = "Select top 10 * from QueueServiceProviders.ProviderInfo where Service_Type like 'Nail Salon%' and Provider_ID in "+ IDList + " ORDER BY NEWID()"; //SQL query string
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';">
                                    ...
                                    try{
                                        ...
                                        while(newsRec.next()){
                                            ...
                                            try{    
                                                ...
                                                if(!ServiceType.contains("Nail Salon")){
                                                    newsItems -= 1;
                                                    continue;
                                                }
                    %>
        ...
        <div id="content">
            ...
            <div id="main">
                                    ...
                                    <td>
                                        <b>
                                            ...
                                            <div style="display: flex; flex-direction: row;">
                                                <div>
                                                    <img style="float: left; margin-right: 3px;" src="icons/icons8-nails-96.png" width="30" height2="30" alt="icons8-home-50 (1)"/>
                                                </div>
                ...
                <form name="GetMoreRecords" action="QueueSelectNailSalonLoggedIn.jsp">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                ...
                %>
                    <center><p style="font-size: 16px; background-color: red; color: white; margin-top: 200px; width: fit-content; padding: 5px;">
                        No Nail Salon services found at this time. Use search box above to explore more
                    </p></center>
                <%
                    }
                %>
            ...
            <div id="ExtraproviderIcons" style="">
             ...
             <center><h4 style="margin: 5px; margin-top: 15px;">Explore Service Providers</h4></center>
                ...
                <center><table id="providericons">
                        ...
                        <tr>
                            <td><center><a onclick="document.getElementById('PageLoader').style.display = 'block';" href="QueueSelectHolisticMedicineLoggedIn.jsp?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>"><p style="margin:0;" name="HolMedSelect">Holistic Medicine</p><img src="icons/icons8-pill-filled-70.png" width="70" height="70" alt="icons8-pill-filled-70"/>
                            </a></center></td>
                ...
                <div id="secondSetProvIcons" style="display: none;">
                    <center><table id="providericons">
                        ...
                        <tr>
                            <td><center><a onclick="document.getElementById('PageLoader').style.display = 'block';" href="QueueSelectHomeServLoggedIn.jsp?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>&User=<%=NewUserName%>"><p style="margin:0;" name="HomeServicesSelect">Home Services</p><img src="icons/icons8-home-filled-70.png" width="70" height="70" alt="icons8-home-filled-70"/>
                            </a></center></td>
                            <td><center><a onclick="document.getElementById('PageLoader').style.display = 'block';" href="QueueSelectPiercingLoggedIn.jsp?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>&User=<%=NewUserName%>"><p style="margin:0;" name="PiercingSelect">Piercing</p><img src="icons/icons8-piercing-filled-70.png" width="70" height="70" alt="icons8-piercing-filled-70"/>
                            </a></center></td>
                            <td><center><a onclick="document.getElementById('PageLoader').style.display = 'block';" href="QueueSelectTattooLoggedIn.jsp?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>&User=<%=NewUserName%>"><p style="margin:0;">Tattoo Shop</p><img src="icons/icons8-tattoo-machine-filled-70.png" width="70" height="70" alt="icons8-tattoo-machine-filled-70"/>
                            </a></center></td>
                        <tr>
