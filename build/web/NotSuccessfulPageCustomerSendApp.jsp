...
<html>
    ...
    <%
        ...
        try{
            ProviderID = request.getAttribute("ApptProvID").toString();
            OrderedServices = request.getAttribute("ApptServices").toString();
            Date = request.getAttribute("ApptDate").toString();
            Time = request.getAttribute("ApptTime").toString();
            PaymentMethod = request.getAttribute("ApptPayMeth").toString();
            CreditCardNumber = request.getAttribute("ApptCardNum").toString();
            Price = request.getAttribute("ApptCost").toString();
        }catch(Exception e){}
        ...
        JOptionPane.showMessageDialog(null, CreditCardNumber);
            ...
            <div id="main" style="min-height: 100%;">
                ...
                <form name="login" action="LoginAndSendAppointmentController" method="POST">
                    ...
                    <fieldset class="loginInputFld">
                        ...
                        <input placeholder="enter your username here" type="text" name="username" value="<%=UserName%>" />
                    </fieldset>
                    <fieldset class="loginInputFld" style="margin-top: 5px;">
                        ...
                        <input style="background-color: darkslateblue; border: none; padding: 10px 5px; width: 150px; border-radius: 4px;" type="submit" value="Login" />
                </form>
