       ...
       class getUserDetails{
           ...
           public ResultSet getRecords(){
               ...
               try{
                    ...
                    String  select = "Select top 10 * from QueueServiceProviders.ProviderInfo where Service_Type like 'Beauty Salon%' and Provider_ID in "+ IDList + " ORDER BY NEWID()"; //SQL query string
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';">
                                    ...
                                    try{
                                        ...
                                        while(newsRec.next()){
                                            ...
                                            try{    
                                                ...
                                                if(!ServiceType.contains("Beauty Salon")){
                                                    newsItems -= 1;
                                                    continue;
                                                }
                    %>
                        ...
                        try{
                            ...
                            while(newsRec.next()){
                                ...
                                try{    
                                    ...
                                    if(!ServiceType2.contains("Beauty Salon")){
                                        newsItems -= 1;
                                        continue;
                                    }
                %>
        ...
        <div id="content">
            ...
            <div id="main">
                ...
                <form name="GetMoreRecords" action="QueueSelectBeautySalonLoggedIn.jsp?">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
