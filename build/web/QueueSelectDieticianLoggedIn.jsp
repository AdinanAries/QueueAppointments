       ...
       class getUserDetails{
           ...
           public ResultSet getRecords(){
               ...
               try{
                    ...
                    String  select = "Select top 10 * from QueueServiceProviders.ProviderInfo where Service_Type like 'Dietician%' and Provider_ID in "+ IDList + " ORDER BY NEWID()"; //SQL query string
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';">
                                    ...
                                    try{
                                        ...
                                        while(newsRec.next()){
                                            ...
                                            try{    
                                                ...
                                                if(!ServiceType.contains("Dietician")){
                                                    newsItems -= 1;
                                                    continue;
                                                }
                    %>
        ...
        <div id="content">
            ...
            <div id="main">
                ...
                <form name="GetMoreRecords" action="QueueSelectDieticianLoggedIn.jsp">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                ...
                %>
                    <center><p style="font-size: 16px; background-color: red; color: white; margin-top: 200px; width: fit-content; padding: 5px;">
                        No Dietician services found at this time. Use search box above to explore more
                    </p></center>
                <%
                    }
                %>
