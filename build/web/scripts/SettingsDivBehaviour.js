...
function showSettingsDiv(){
	...
	if(SettingsDiv.style.display === "none")
		$("#SettingsDiv").slideDown("fast");
		
	else
		$("#SettingsDiv").slideUp("fast");
}
...
function showLoginFormsDiv(){
	...
	if(UserAcountLoginForm.style.display === "none")
		...
		$("#UserAcountLoginForm").slideUp("fast");
...
function checkLogInFormFieldsStatus(){
	...
	var changeUserAccountStatus = document.getElementById("changeUserAccountStatus");
	...
	if(NewPasswordFld.value === "" || CurrentPasswordFld.value === "" 
		|| ConfirmPasswordFld.value === "" || UpdateLoginNameFld.value === ""){
		...
		else if(NewPasswordFld.value !== ConfirmPasswordFld.value 
...
function PaymentsFormCheckInputs(){
	...
	if(CardNumberFld.value === "" || HoldersNameFld.value === "" 
		|| ExpDateFld.value === "" || SecCodeFld.value === ""){
