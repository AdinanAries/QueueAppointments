    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';" style="padding-bottom: 0; background-color: #ccccff;">
        ...
        <div id="content">
            ...
            <div id="main">
                                    ...
                                    <td>
                                        <b>
                                            ...
                                            <div style="display: flex; flex-direction: row;">
                                                <div>
                                                    <img style="float: left; margin-right: 3px;" src="icons/icons8-workout-96.png" width="30" height2="30" alt="icons8-hair-dryer-50"/>
                                                </div>
                ...
                <form name="GetMoreRecords" action="QueueSelectPersonalTrainer.jsp">
