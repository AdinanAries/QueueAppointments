...
<html>
    ...
    <% 
        ...
        try{
            ...
            //try this block of code since splitting a string into individual words would require that the string infact contains more than a word
            //therefore this operation returns an arror in case of a single word string
            String[] StringParts = Search.split(" "); //spit string into an array of words
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';" style="padding-bottom: 0; background-color: #ccccff;">
        ...
        <div id="Extras">
            ...
            <div style="max-height: 87vh; overflow-y: auto; background: #b5cece;">
                <%
                            ...
                            <center><div style="display: flex; flex-direction: row;">
                                ...
                                <tr>
                                    ...
                                    <%
                                        ...
                                        //Calculate for time of most recent past appoitment possibility
