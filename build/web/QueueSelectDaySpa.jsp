    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';" style="padding-bottom: 0; background-color: #ccccff;">
        ...
        <div id="content">
            ...
            <div id="main">
                ...
                <form name="GetMoreRecords" action="QueueSelectDaySpa.jsp">
        ...
        <div id="newbusiness">
            ...
            <center><form name="AddBusiness" action="SignUpPage.jsp" method="POST"><table border="0">
                    ...
                    <input onclick="document.getElementById('PageLoader').style.display = 'block';" class="button" type="submit" value="Submit" name="submitBtn" />
                </form></center>
