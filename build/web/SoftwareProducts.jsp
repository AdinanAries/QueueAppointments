    ...
    <body>
        ...
        <div id="nav">
                    <ul>
                        ...
                        <a href="SoftwareProducts.jsp"><li class="active" style="background-color: #6699ff; border: black solid 1px; color: #000099;">AriesLab Products</li></a>
                        <a href="ContactUs.jsp"><li>Contact Us</li></a>
                        <a href="OurReputation.jsp"><li>Our Reputation</li></a>
                        <a href="PageController"><li  id="queuenav" style="color: #ff3333; border:#ff3333 solid 1px;" >Queue</li></a>
                ...
                <div id ="main">
                    <h2 style="color: red; margin-top: 25px;">OUR SOFTWARE PRODUCTS</h2>
                </div>
            </div>
            <div id="additional">
