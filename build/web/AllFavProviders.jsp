        ...
        <div id="newbusiness">
            ...
            <div id="ExtraproviderIcons" style="">
                ...
                <center><form action="ByAddressSearchResultLoggedIn.jsp" method="POST" style="background-color: #9bb1d0; border: 1px solid buttonshadow; padding: 5px; border-radius: 5px; width: 90%;">
                    ...
                    <p><input onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';" type="submit" style="background-color: darkslateblue; color: white; padding: 5px; border-radius: 5px; border: none; width: 95%;" value="Search" /></p>
                    </form></center>
                </div>
