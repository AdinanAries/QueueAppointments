...
<html>
    ...
    <% 
        ...
        try{
            Class.forName(Driver);
            Connection ProvsConn = DriverManager.getConnection(url, User, Password);
            String ProvsQuery = "Select * from ProviderCustomers.FavoriteProviders where CustomerId = ?";
            PreparedStatement ProvsPst = ProvsConn.prepareStatement(ProvsQuery);
            ProvsPst.setInt(1, UserID);
            
            ResultSet ProvsRec = ProvsPst.executeQuery();
            
            while(ProvsRec.next()){
                ProviderIDList.add(ProvsRec.getInt("ProviderId"));
            }
    ...
    <%!
       ...
       class getUserDetails{
           ...
           private String Driver; //Driver Class
           private String url; //url (database)
           private String User; //datebase user account
    ...
    <body  onload="document.getElementById('AllFavoritesPageLoader').style.display = 'none';">
        ...
        <div id="PermanentDiv" style="">
            ...
            <a href="PageController?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>" id='ExtraDrpDwnBtn' style='margin-top: 2px; margin-left: 2px;float: left; width: 80px; font-weight: bolder; padding: 4px; cursor: pointer; background-color: cadetblue; color: white; border-radius: 4px;'>
            ...
            <ul>
                <a onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"  href="PageController?UserIndex=<%=UserIndex%>&User=<%=NewUserName%>">
            ...
            <div id="ExtraDivSearch" style='background-color: cadetblue; padding: 3px; padding-right: 5px; padding-left: 5px; margin-top: 1.2px; border-radius: 4px; max-width: 590px; float: right; margin-right: 5px;'>
                <form action="QueueSelectBusinessSearchResultLoggedIn.jsp" method="POST">
                    <input style="width: 450px; margin: 0; background-color: #d9e8e8; height: 30px; border-radius: 4px; font-weight: bolder;"
                            placeholder="Search service provider" name="SearchFld" type="text"  value="Favorite Providers" />
            ...
            <div id="miniNav" style="display: none;">
                <center>
                    ...
                    <form name="miniDivSearch" action="QueueSelectBusinessSearchResultLoggedIn.jsp" method="POST">
                            ...
                            <input type="submit" value="Search" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';" />
                    </form>
                </center>
            </div>
        ...
        <div id="header">
            ...
            <a onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';" href="PageController?UserIndex=<%=Integer.toString(UserIndex)%>&User=<%=NewUserName%>" style=" color: black;"><image src="QueueLogo.png" style="margin-top: 5px;"/></a>
            ...
            <div id="nav">
                ...
                <center><div class =" SearchObject">
                    ...
                    <form name="searchForm" action="QueueSelectBusinessSearchResultLoggedIn.jsp" method="POST">
                        <input type="hidden" name="User" value="<%=NewUserName%>" />
                        <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                        <input placeholder='Search Service Provider' class="searchfld" value="" type="text" name="SearchFld" size="" /><input class="searchbtn" type="submit" value="Search" name="SearchBtn" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"/>
                    </form> 
            ...
            <div id="main">
                ...
                <center><table id="providerdetails" style="">
                    ...
                    <%
                        ...
                        String SString = Integer.toString(i);
                        ...
                        String FavProvID = Integer.toString(providersList.get(i).getID());
                    ...
                    %>
                            ...
                            <tbody id="FavoriteProvDiv<%=SString%>">
                            <tr>
                            <td>
                            <center>    
                            ...
                            <input type="hidden" name="UserIndex" value="<%=UserIndex%>"/>
                            <input type="hidden" name="User" value="<%=NewUserName%>" />
                            <input id="eachprov" type="submit" value="I will choose a different spot" name="submit" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';" />
                            </form></center>
                            ...
                            <!--div style="">
                                    <div class="tooltip" style="max-width: 2px; float: right; padding-top: 15px;">
                                            ...
                                            <p style="text-align: center;"><input id="DeleteFavProvBtn<%=SString%>" style="background-color: crimson; text-align: center; border: 0; color: white; border-radius: 4px; padding: 5px; cursor: pointer;" 
                                            ...
                                            <script>
                                               $(document).ready(function() {                        
                                                    $('#DeleteFavProvBtn<%=SString%>').click(function(event) {  
                                                        document.getElementById('AllFavoritesPageLoader').style.display = 'block';
                                                        ...
                                                        success: function(result){  
                                                          alert(result);
                                                          document.getElementById('AllFavoritesPageLoader').style.display = 'none';
        ...
        <div id="newbusiness">
            ...
            <div id="ExtraproviderIcons" style="">
                ...
                <center><form action="ByAddressSearchResultLoggedIn.jsp" method="POST" style="background-color: #9bb1d0; border: 1px solid buttonshadow; padding: 5px; border-radius: 5px; width: 90%;">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                    <p style="color: #000099; margin: 4px;">Find services near you</p>
                    ...
                    <p><input onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';" type="submit" style="background-color: #626b9e; color: white; padding: 5px; border-radius: 5px; border: none; width: 95%;" value="Search" /></p>
                    </form></center>
                </div>
             ...
             <center><h4 style="margin: 5px; margin-top: 15px;">Explore Service Providers</h4></center>
                ...
                <center><table id="providericons">
                        ...
                        <tr>
                            ...
                            <td style="width: 33.3%;"><center><a href="QueueSelectMakeUpArtistLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="MakeupArtistSelect">Makeup Artist</p><img src="icons/icons8-cosmetic-brush-filled-70.png" width="70" height="70" alt="icons8-cosmetic-brush-filled-70"/>
                            </a></center></td>
                        </tr>
                        <tr>
                            <td><center><a href="QueueSelectPodiatryLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="PodiatrySelect">Podiatry</p><img src="icons/icons8-foot-filled-70.png" width="70" height="70" alt="icons8-foot-filled-70"/>
                            </a></center></td>
                            <td><center><a href="QueueSelectHairSalonLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;">Hair Salon</p><img src="icons/icons8-woman's-hair-filled-70.png" width="70" height="70" alt="icons8-woman's-hair-filled-70"/>
                            </a></center></td>
                            <td><center><a href="QueueSelectMassageLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="MassageSelect">Massage</p><img src="icons/icons8-massage-filled-70.png" width="70" height="70" alt="icons8-massage-filled-70"/>
                            </a></center></td>
                        </tr>
                        <tr>
                            <td><center><a href="QueueSelectHolisticMedicineLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="HolMedSelect">Holistic Medicine</p><img src="icons/icons8-pill-filled-70.png" width="70" height="70" alt="icons8-pill-filled-70"/>
                            </a></center></td>
                            <td><center><a href="QueueSelectMedAesthetLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="MedEsthSelect">Aesthetician</p><img src="icons/icons8-cleansing-filled-70.png" width="70" height="70" alt="icons8-cleansing-filled-70"/>
                            </a></center></td>
                ...
                <div id="secondSetProvIcons" style="display: none;">
                    <center><table id="providericons">
                        ...
                        <tr>
                            ...
                            <td style="width: 33.3%;"><center><a href="QueueSelectPetServLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="PetServicesSelect">Pet Services</p><img src="icons/icons8-dog-filled-70.png" width="70" height="70" alt="icons8-dog-filled-70"/>
                            </a></center></td>
                        </tr>
                        <tr>
                            <td><center><a href="QueueSelectHomeServLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="HomeServicesSelect">Home Services</p><img src="icons/icons8-home-filled-70.png" width="70" height="70" alt="icons8-home-filled-70"/>
                            </a></center></td>
                            <td><center><a href="QueueSelectPiercingLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="PiercingSelect">Piercing</p><img src="icons/icons8-piercing-filled-70.png" width="70" height="70" alt="icons8-piercing-filled-70"/>
                            </a></center></td>
                            <td><center><a href="QueueSelectTattooLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;">Tattoo Shop</p><img src="icons/icons8-tattoo-machine-filled-70.png" width="70" height="70" alt="icons8-tattoo-machine-filled-70"/>
                            </a></center></td>
                        <tr>
                            <td><center><a href="QueueSelectNailSalonLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="NailSalonSelect">Nail Salon</p><img src="icons/icons8-nails-filled-70.png" width="70" height="70" alt="icons8-nails-filled-70"/>
                            </a></center></td>
                            <td><center><a href="QueueSelectPersonalTrainerLoggedIn.jsp?UserIndex=<%=UserIndex%>" onclick="document.getElementById('AllFavoritesPageLoader').style.display = 'block';"><p style="margin:0;" name="PersonalTrainSelect">Personal Trainer</p><img src="icons/icons8-personal-trainer-filled-70.png" width="70" height="70" alt="icons8-personal-trainer-filled-70"/>
                            </a></center></td>
