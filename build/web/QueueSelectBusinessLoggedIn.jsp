            ...
            <div id="main">
                ...
                <center><table id="providerdetails" style="">
                    ...
                    %>
                            ...
                            <input type="hidden" name="UserID" value="<%=SID%>" />
                            <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                            <input id="eachprov" type="submit" onclick="document.getElementById('PageLoader').style.display = 'block';" value="I will choose a different spot" name="submit" />
                            </form></center>
                ...
                <form name="GetMoreRecords" action="QueueSelectBusinessLoggedIn.jsp">
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
