...
<html>
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';" style="padding-bottom: 0; background-color: #ccccff;">
        ...
        <div id="PermanentDiv" style="">
            ...
            <div id="ExtraDivSearch" style='background-color: cadetblue; padding: 3px; padding-right: 5px; padding-left: 5px; margin-top: 1.2px; margin-top: 1.2px; border-radius: 4px; max-width: 590px; float: right; margin-right: 5px;'>
        ...
        <div id="content">
            ...
            <div id="main">
                                    ...
                                    <td>
                                        <b>
                                            ...
                                            <div style="display: flex; flex-direction: row;">
                                                <div>
                                                    <img style="float: left; margin-right: 3px;" src="icons/icons8-hospital-3-50.png" width="30" height2="30" alt="icons8-hair-dryer-50"/>
                                                </div>
                ...
                <form name="GetMoreRecords" action="QueueSelectMedicalCenter.jsp">
