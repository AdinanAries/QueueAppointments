...
<html>
    ...
    %>
        ...
        %>
                        ...
                        <%}%>
                                    <a onclick="document.getElementById('PageLoader').style.display = 'block';" href='ViewSelectedProviderReviews.jsp?UserIndex=<%=UserIndex%>&Provider=<%=ProviderID%>'><p style='clear: both; text-align: center; color: #334d81; cursor: pointer; padding-top: 20px;'>See More...</p></a>
                        </div>
                    </div>
        </div></center>
                                ...
                                <div id="serviceslist" style="border: 0; padding-bottom: 20px;">
                                    ...
                                    <table id="hoursTable" style="border-spacing: 0; box-shadow: 0; margin-left: 0;  width: 100%;">
                                     ...
                                     <p style="color: #334d81; font-weight: bolder; padding: 15px 0; text-align: center;">
                                        ...
                                        <p id="SVCSelectStatus" style="text-align: center;  margin: 15px 0 !important; color: darkblue; font-weight: bolder;"></p>
                                            ...
                                            <input type="hidden" name="User" value="<%=NewUserName%>" />
                                                   ...
                                                   <p style="text-align: center; color: darkblue; font-weight: bolder; margin: 10px 0;"><i class="fa fa-exclamation-triangle" style="color: red;"></i> You're not allowed to schedule with <%=fullName%></p>
                                                   <%}%>
