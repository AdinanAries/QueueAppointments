...
<html>
    ...
    %>
        ...
        <div id="header">
            ...
            <center><p style="color: #254386; font-size: 16px; font-weight: bolder; margin-bottom: 10px;">News Updates from <%=NewsProvName%></p></center>
        ...
        %>
            ...
            <a href='ViewSelectedProviderReviews.jsp?UserIndex=<%=UserIndex%>&Provider=<%=ProviderID%>'><p style='clear: both; text-align: center; color: greenyellow; cursor: pointer;'>See More...</p></a>
