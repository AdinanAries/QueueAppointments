...
<html>
    ...
    <%!
       ...
       class getUserDetails{
            ...
            ArrayList<Integer> ProviderIDsFromAddress = new ArrayList<>();;
           ...
           public ResultSet getRecords(){
               ...
               try{
                    ...
                    String  select = "Select top 10 * from QueueServiceProviders.ProviderInfo where Service_Type like 'Barber%' and Provider_ID in "+ IDList + " ORDER BY NEWID()"; //SQL query string
    ...
    %>
        ...
        <%
            ...
            details.getIDsFromAddress(City, Town, ZipCode);
    ...
    <body onload="document.getElementById('PageLoader').style.display = 'none';">
        ...
        <div id="PermanentDiv" style="">
            ...
            <div id="ExtraDivSearch" style='background-color: cadetblue; padding: 3px; padding-right: 5px; padding-left: 5px; border-radius: 4px; margin-top: 1.2px; max-width: 590px; float: right; margin-right: 5px;'>
                                    ...
                                    try{
                                        ...
                                        while(newsRec.next()){
                                            ...
                                            try{    
                                                ...
                                                if(!ServiceType.contains("Barber")){
                                                    newsItems -= 1;
                                                    continue;
                                                }
                    %>
                                ...
                                try{    
                                    ...
                                    try{
                                        ...
                                        while(ProvRec.next()){
                                            ...
                                            ServiceType2 = ProvRec.getString("Service_Type").trim();
                                    ...
                                    if(!ServiceType2.contains("Barber")){
                                        newsItems -= 1;
                                        continue;
                                    }
                %>
        ...
        <div id="content">
            ...
            <div id="main">
                ...
                <form name="GetMoreRecords" action="QueueSelectBarberBusinessLoggedIn.jsp">
                    <input type="hidden" name="UserIndex" value="<%=UserIndex%>" />
                    <input type="hidden" name="User" value="<%=NewUserName%>" />
                ...
                %>
                    <center><p style="font-size: 16px; background-color: red; color: white; margin-top: 200px; width: fit-content; padding: 5px;">
                        No Barber services found at this time. Use search box above to explore more
                    </p></center>
                <%
                    }
                %>
        ...
        <div id="newbusiness">
            ...
            <div id="ExtraproviderIcons" style="">
                ...
                <center><form action="ByAddressAndTypeSearchResultLoggedIn.jsp" method="POST" style="background-color: #9bb1d0; border: 1px solid buttonshadow; padding: 5px; border-radius: 5px; width: 90%;">
                    ...
                    <p>City: <input style="width: 80%; background-color: #d9e8e8;" type="text" name="city4Search" placeholder="" value="<%=City%>"/></p> 
                    <p>Town: <input style="background-color: #d9e8e8; width: 40%" type="text" name="town4Search" value="<%=Town%>"/> Zip: <input style="width: 19%; background-color: #d9e8e8;" type="text" name="zcode4Search" value="<%=ZipCode%>" /></p>
