 ...
 * @author aries
 */
public class SaveStripeCustId extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String StripeCustId = request.getParameter("StripeCustId");
        ...
        try{
            ...
            String saveString = "insert into QueueObjects.StripSubscriptions (StripeCustomerId, ProvId)"
                    + "values (?, ?)";
            PreparedStatement savePst = saveConn.prepareStatement(saveString);
            savePst.setString(1, StripeCustId);
